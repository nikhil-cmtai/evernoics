  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-20 px-4">
      ...
      <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <p className="text-gray-600">locationtrack@gmail.in</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">T-4, Sanjay Gandhi Puram, Lucknow, Uttar Pradesh 226016 India</p>
              </motion.div>
            </div>
        ...
        <div className="w-full mx-auto mt-12 rounded-xl overflow-hidden shadow-lg border border-orange-100">
              <iframe
